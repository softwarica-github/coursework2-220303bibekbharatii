...
class AntivirusAnimation(tk.Toplevel):
    def __init__(self, parent, task, task_generator):
        ...
        self.progress_bar.grid(row=0, column=0, pady=20, padx=20, sticky="ew")

        self.progress_label = ttk.Label(self, text=task)
    ...
    def update_progress(self):
        try:
            ...
            self.destroy()
            self.parent.update()  # Update the main window to reflect changes
